...
class Rocket:
    def __init__(self, tanks_height=2, radius=0.07, others_mass=4, mdot=0.5, o_f=1):
        ...
        self.fings_num = 3
        self.max_mass = 30  # kg
        self.lox_tube = self.tanks.lox_height + ((self.loxCap_h+self.fuelLox_h)/2)
...
if __name__ == "__main__":
    roc = Rocket(radius=0.06, tanks_height=1)
